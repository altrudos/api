...
type RouteMatcher interface {
	...
	Match(method, path string, params *RouteParams) (string, bool)
...
// A route context modifier modifies the route context
// based on the provided route.
type RouteContextModifier interface {
	Modify(route *Route, ctx *RouteContext)
}
...
func MatchPathToMatcher(path string, route *Route) (RouteMatcher, string, error) {
	tests := []RouteMatcher{
...
func (r *RouteMatcherRoot) Match(method, path string, params *RouteParams) (string, bool) {
...
func (r *RouteMatcherString) Match(method, path string, params *RouteParams) (string, bool) {
...
func (r *RouteMatcherPlaceholder) Match(method, path string, params *RouteParams) (string, bool) {
