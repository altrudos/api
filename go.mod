module github.com/altrudos/api
...
require (
	...
	github.com/tmathews/commander v0.0.0-20190301170804-7e1e7f4994f7
	github.com/vindexus/randomwords v0.0.0-20200328185201-47a1f6344ee2
